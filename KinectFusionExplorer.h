...
public:
	...
	/// </summary>
	HRESULT CreatePointCloud(INuiFusionColorMesh* mesh, bool flipYZ, bool outputColor);

	/// <summary>
	/// Starts the scanning process
	/// </summary>
	HRESULT StartScanner();

	/// <summary>
	/// Opens a mesh file
	/// </summary>
	HRESULT OpenMeshFile();

	/// <summary>
	/// Reconstruct Mesh using selected parameters
	/// </summary>
	HRESULT ReconstructMesh();

	/// <summary>
	/// Save Mesh 
	/// </summary>
	HRESULT SaveMesh(pcl::PolygonMesh mesh, KinectFusionMeshTypes saveMeshType);
...
private:
	...
	bool                        m_bDisplayCloud;
	bool                        m_bDisplayCloudWithNormals;
	bool                        m_bDisplayMesh;
	bool                        m_bDisplayProcessedMesh;
