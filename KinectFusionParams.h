...
enum ReconstructionAlgorithms
{
	Poisson = 0,
	MarchingCubes = 1,
	GreedyTriangulation = 2
};
...
struct KinectFusionParams
{
    ...
    KinectFusionParams() :
		...
		m_bVoxelGridFilter(true),
		m_ReconstructionAlgorithm(Poisson),
		m_bOutliersRemoval(false),
		m_bPassthroughFilter(false),
		m_bBilateralFilter(false),
		m_bFastBilateralFilter(false),
		m_bMovingLeastSquares(false),
		m_bCropBoxFilter(false)
    {
        ...
        m_reconstructionParams.voxelCountY = 512;       // Memory = 384*384*384 * 4bytes per voxel
	...
	/// </summary>
	bool                m_bVoxelGridFilter;
	bool                m_bOutliersRemoval;
	bool                       m_bPassthroughFilter;
	bool                       m_bBilateralFilter;
	bool                       m_bFastBilateralFilter;
	bool                       m_bCropBoxFilter;
	bool                       m_bMovingLeastSquares;
	ReconstructionAlgorithms   m_ReconstructionAlgorithm;
